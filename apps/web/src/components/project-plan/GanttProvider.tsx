...
import { addDays, differenceInDays, startOfMonth, endOfMonth, startOfWeek, endOfWeek, format, isSameDay } from 'date-fns';
...
export const GanttProvider = ({ children, activities, milestones, onSelectActivity }: GanttProviderProps) => {
    ...
    const { startDate, endDate } = useMemo(() => {
        ...
        // Include Today in the range so the "Today" line is always visible/relevant
        ...
        // Add padding
        return {
            startDate: startOfWeek(addDays(min, -7)),
