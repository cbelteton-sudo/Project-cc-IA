  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="h-12 border-b border-gray-200 flex items-center justify-between px-4 bg-gray-50 flex-shrink-0 relative z-50">
        ...
        <div className="flex items-center gap-4">
          {/* Legend */}
          <div className="flex items-center gap-3 bg-white px-3 py-1.5 rounded-md border border-gray-200 text-[10px] font-medium text-gray-600 shadow-sm">
      ...
      <div ref={containerRef} className="flex-1 flex overflow-hidden relative">
        ...
        <div
          ...
          className="flex flex-col border-r border-gray-200 bg-white z-10"
        >
          <GanttWBS />
        </div>
