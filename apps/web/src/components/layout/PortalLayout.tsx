...
const PortalSidebarItem = ({ to, icon: Icon, label }: any) => (
  <Link
    to={to}
    className="flex items-center gap-3 px-3 py-2 text-gray-300 hover:bg-slate-800 hover:text-white rounded-md transition-colors"
  >
    <Icon size={20} />
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col text-gray-300">
        <div className="h-16 flex items-center px-6 border-b border-slate-800">
          <span className="font-bold text-white text-lg tracking-tight">
            Contractor<span className="text-blue-500">Portal</span>
          </span>
        </div>
