...
import { OfflineManager, QueueItem } from '../../services/offline-manager';
            ...
            <div className="p-4 max-w-2xl mx-auto space-y-4">
                ...
                <div className="space-y-3">
                    {loading && items.length === 0 ? (
                        ...
                        items.map(item => (
                            <div key={item.localId} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col gap-3">
                                ...
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span className={`text-xs font-bold px-2 py-1 rounded-md ${item.lastError ? 'bg-red-50 text-red-600' : 'bg-yellow-50 text-yellow-600'}`}>
                                ...
                                {(item.photos && item.photos.length > 0) && (
                                    <div className="flex gap-2 overflow-x-auto pb-1">
                                        {item.photos.map(p => (
                                            <div key={p.id} className="w-12 h-12 rounded-lg bg-gray-100 shrink-0 overflow-hidden">
