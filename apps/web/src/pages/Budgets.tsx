      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 tracking-tight">
            Directorio de Presupuestos
          </h2>
          <p className="text-gray-500 mt-1">
            Selecciona un proyecto para gestionar su control financiero.
          </p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-field-blue text-white shadow-md z-10 relative">
              <tr>
                ...
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-right text-white/80">
                  Presupuesto Global
                </th>
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-center text-white/80">
                  Acciones
