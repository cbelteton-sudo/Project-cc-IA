...
INSERT INTO "new_Issue" ("activityId", "createdAt", "createdBy", "description", "dueDate", "id", "ownerUserId", "projectId", "severity", "status", "title", "updatedAt") SELECT "activityId", "createdAt", "createdBy", "description", "dueDate", "id", "ownerUserId", "projectId", "severity", "status", "title", "updatedAt" FROM "Issue";
DROP TABLE "Issue";
...
INSERT INTO "new_Project" ("code", "createdAt", "currency", "endDate", "globalBudget", "id", "name", "startDate", "status", "tenantId", "updatedAt") SELECT "code", "createdAt", "currency", "endDate", "globalBudget", "id", "name", "startDate", "status", "tenantId", "updatedAt" FROM "Project";
DROP TABLE "Project";
